 ...
 * @author DELL
 */
@WebServlet(name = "AddDeliveryManWorkingArea", urlPatterns = {"/AddDeliveryManWorkingArea.do"})
public class AddDeliveryManWorkingArea extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String res=null;
       /* if(action.equalsIgnoreCase("Remove this working area")){
        ...
        System.out.print("add deliveryman workarea: "+dmId+thana+zilla);
         res = da.addDeliveryManWorkingArea(dmId, thana, zilla);
       // }
        System.out.println("dfasf"+res);
