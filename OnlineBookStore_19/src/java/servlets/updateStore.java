...
import static Interfaces.SharedConstants.BOOK_ADDED;
import static Interfaces.SharedConstants.BOOK_UPDATED;
 ...
 * @author MiNNiE
 */
@WebServlet(name = "updateStore", urlPatterns = {"/updateStore.do"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       // String category = request.getParameter("categoryName");
        ...
        if(errFlag==false){
            ...
            String result = db.updateBook(title,author,publisher,cat,price,isbn,pubYear,edition,language,pageNo,description,quantity,discount,admin,bid);
            System.out.println(result);
            if(result.equals(BOOK_UPDATED))
            {
