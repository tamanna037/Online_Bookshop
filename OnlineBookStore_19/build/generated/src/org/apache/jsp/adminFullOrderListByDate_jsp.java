...
public final class adminFullOrderListByDate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Full order List</title>\n");
      out.write("\n");
      out.write("<style>\n");
      ...
      out.write(" \n");
      out.write("        <h1>Full Order List</h1>\n");
      out.write("        ");
        ...
        out.print("<table>");
            ...
            if(cart==null){
               ...
               for(count = 0;count<length;count++){
                ...
                totalPrice += 50;
                out.println("<tr><td></td><td></td><td></td><td>Total Price :</td><td>"+orderDetails.getTotalPrice()+" </td><td></td></tr>");
                }
            } 
        out.println("</table> ");
                }
